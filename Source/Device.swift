...
public enum Device {
    ...
    public init() {
        ...
        func mapIdentifierToDevice(identifier: String) -> Device {
                ...
                case "iPad6,3", "iPad6,4":                      return iPadPro10Inch
                case "iPad6,7", "iPad6,8":                      return iPadPro13Inch
    ...
    public static var allPads: [Device] {
        return [.iPad2, .iPad3, .iPad4, .iPadAir, .iPadAir2, .iPadMini, .iPadMini2, .iPadMini3, .iPadMini4, .iPadPro10Inch, iPadPro13Inch]
    }
    ...
    /**
     ...
     case .iPhone4, iPhone4s, .iPhone5, .iPhone5s, .iPhone6, .iPhone6Plus, .iPhone6s, .iPhone6sPlus, .iPhoneSE, .iPhone7, .iPhone7Plus: callMethodOnIPhones()
...
extension Device: CustomStringConvertible {
    ...
    public var description: String {
            ...
            case .iPadPro10Inch:                return "10-inch iPad Pro"
            case .iPadPro13Inch:                return "13-inch iPad Pro"
